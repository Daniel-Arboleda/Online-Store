...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function handleResponse(data) {
        ...
        if (data.message === 'Ambos campos son del mismo producto') {
            messageDiv.textContent = 'Ambos campos son del mismo producto';
            submitButton.textContent = 'Actualizar';
            submitButton.disabled = false;
            autofillForm(data.product);
        } else if (data.message === 'Los campos pertenecen a productos distintos') {
            messageDiv.textContent = 'Los campos pertenecen a productos distintos';
            submitButton.textContent = 'Crear';
            submitButton.disabled = true;
            clearForm();
        } else if (data.message === 'El nombre del producto no existe en la DB') {
            messageDiv.textContent = 'El nombre del producto no existe en la DB';
            submitButton.textContent = 'Crear';
            submitButton.disabled = false;
            clearForm();
        } else if (data.message === 'El código del producto no existe en la DB') {
            messageDiv.textContent = 'El código del producto no existe en la DB';
            submitButton.textContent = 'Crear';
            submitButton.disabled = false;
            clearForm();
        } else if (data.message === 'Crear nuevo producto') {
            messageDiv.textContent = 'Crear nuevo producto';
            submitButton.textContent = 'Crear';
            submitButton.disabled = false;
            clearForm();
        }
