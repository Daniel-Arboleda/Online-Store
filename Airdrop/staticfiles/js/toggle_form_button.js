...
//  implementaremos un script JavaScript que detecte si el código de producto o el nombre del producto ya existen en la base de datos y auto-rellene el formulario en consecuencia.
document.addEventListener('DOMContentLoaded', function() {
    ...
    function autofillForm(product) {
        ...
        document.getElementById('name_prod').value = product.name;
        // Rellenar el resto de campos del formulario según sea necesario
        // Ejemplo: document.getElementById('description').value = product.description;
    ...
    document.getElementById('name_prod').addEventListener('change', function() {
